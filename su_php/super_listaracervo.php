...
<body>
<?php
suPrintCabecalho(SUMENSP076);
$menu = array(
		// Mensagem,link,target,separador
		array(SUMENSP071,"./super_listaracervo.php","_self"," | "),
...
#}
$num=0;
$files = glob("$pastaimagens/*.pdf");
foreach  ($files  as &$value) {
	$num++;
    echo $num.") &nbsp;&nbsp;&nbsp;".basename($value)."<br />";
}
suPrintRodape2(SUMENSP071,"./super_listaracervo.php",SUMENSP006,"./super_admin.php");
?>
</body>
</html>
